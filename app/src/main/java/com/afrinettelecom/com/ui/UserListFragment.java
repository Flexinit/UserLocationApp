...
import com.afrinettelecom.com.models.ClusterMarker;
import com.afrinettelecom.com.models.PolylineData;
...
import com.afrinettelecom.com.util.MyClusterManagerRenderer;
import com.afrinettelecom.com.util.ViewWeightAnimationWrapper;
import com.afrinettelecom.com.adapters.UserRecyclerAdapter;
...
import static com.afrinettelecom.com.Constants.MAPVIEW_BUNDLE_KEY;
...
public class UserListFragment extends Fragment implements
    ...
    private AutoCompleteTextView input_search_user;
    ...
    private ChatroomActivity mChatRoom;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (mUserLocations.size() == 0) { // make sure the list doesn't duplicate by navigating back
            if (getArguments() != null) {
                ...
                // mUserLocations = ChatroomActivity.mUserLocations;
            }

        }
        Log.e("LOCATIONS APPC", AppConfig.userLocations.toString());
        ((ChatroomActivity) getActivity()).progressDialog.dismiss();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        input_search_user = view.findViewById(R.id.input_search_user);
        Log.e("LOCATIONS oncreate", ((ChatroomActivity) getActivity()).userLocationArrayList.toString());
        btn_search.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                ((ChatroomActivity) getActivity()).getSearchedChatroomUsers(input_search_user.getText().toString());
    ...
    private void addMapMarkers() {
        ...
        if (mGoogleMap != null) {
            ...
            for (UserLocation userLocation : AppConfig.userLocations) {
